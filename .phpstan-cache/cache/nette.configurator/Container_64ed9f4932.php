...
class Container_64ed9f4932 extends _PHPStan_51dd92830\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0440(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_64ed9f4932 $container)
			{
	...
	public function createServiceContainer(): Container_64ed9f4932
	{
		return $this;
	}
